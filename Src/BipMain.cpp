...
namespace Bip
{
	...
	const char* Languages[] = { "chinese_simplified", "chinese_traditional", "czech", "english", "french", "italian", "japanese", "korean", "portuguese", "spanish" };
...
void Bip::ComputeWordsFromEntropy(const char* words[], int numWords)
{
	...
	for (int w = 0; w < numWords; w++)
	{
		...
		words[w] = Bip39WordList_english[wordIndex];
	}
