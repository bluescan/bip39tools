...
namespace Dictionary
{
	...
	// exact word in the first place, it still works and returns it. Prefix is case insensitive. Returned
	// word is always lower-case.
	tString GetFullWord(const tString& prefix, Language = Language::English);
	...
	void GetMatchingWords(tList<tStringItem>& words, const tString& prefix, Language = Language::English);
	...
	uint32 GetBits(const tString& fullWord, Language = Language::English);
